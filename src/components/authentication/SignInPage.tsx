...
const RegLogin = () => {
  ...
  return (
    <section className="relative w-full h-[100vh]">
        <div className="relative items-center w-full h-full rounded-sm border bg-white md:flex">
            <Link href='/'><Image className="absolute w-[20%] top-3 left-5 border px-2 py-1 rounded md:hidden" src={talkteonLogoB} alt="logo"/></Link> 
            <div className="hidden md:block relative w-2/3 h-dvh">
            <Link href='/'><Image className="absolute w-[20%] top-3 left-5 shadow border px-2 py-1 rounded sm:hidden md:block" src={talkteonLogoW} alt="logo"/></Link>
                <Image src={loginMeetingCover} alt="business cover" className="w-full h-full" />
            </div>
            <aside className=" px-10 py-6 flex flex-col items-center h-fit w-full md:w-1/3 md:m-auto space-y-3 mt-40">
                <h2 className="font-bold text-2xl self-start">Login</h2>
                <p className="text-xs text-slate-500 self-start">Welcome back! please enter your details.</p>
                <div className="w-full">
                    <form action="" className="w-full flex flex-col">
                        <label htmlFor="email">Email</label>
                        <input type="email" id="email" name="email-address" placeholder="Enter your Email" />
                        <p className="text-xs text-slate-500 ml-1 ">Enter your registered email address</p>
                        ...
                        <div className="flex justify-between place-items-center mt-3">
                            <div className="">
                                ...
                                <label htmlFor="passR" className="text-xs ml-1 font-semibold ">Remember for 30 days</label>
                            </div>
                            <a href="/forgotPassword"><p className="text-xs text-slate-500 font-semibold ">Forgot Password?</p></a>
                        </div>
        ...
        <div className="hidden absolute top-0 w-full h-full bg-[rgb(0,0,0,0.4)] flex place-items-center">
